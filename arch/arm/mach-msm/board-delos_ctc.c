...
#include "proc_comm.h"
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_S2200_I2C
...
static unsigned char tm2303_f1a_button_codes[] = {KEY_MENU, KEY_HOME, KEY_BACK};
...
////////////////////////////////////////////////////////////////////////////
	...
	if (board_hw_revision < 4) {
		...
		aries_charger.charger_ic = &smb328a_pdata;
	}

	printk("%s [HYM] ta_curr= %d, usb_curr = %d \n", __func__, aries_charger.charger_ic->chg_curr_ta, aries_charger.charger_ic->chg_curr_usb);
#endif
